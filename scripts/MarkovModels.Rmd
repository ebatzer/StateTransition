...
bind_rows(Nprob) %>%
  ...
  scale_color_manual(name = 'Initial State', 
         ...
         labels = c('Natives','High Priority', 'WAPS','Drought Tol.')) +
...
ggsave("../figures/StabilityProbabilities_NoErrorBars.pdf", height = 6, width = 8)
...
ggsave("../figures/TransitionProbabilities_NoErrorBars.pdf", height = 14, width = 8)
```
