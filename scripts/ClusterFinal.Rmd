...
clustdat$cluster[clustdat$cluster == 2] = "High Priority"
clustdat$cluster[clustdat$cluster == 3] = "Invasives"
clustdat$cluster[clustdat$cluster == 4] = "Drought Tol."
...
ggsave("../figures/TrackingStates.jpeg", height = 6, width = 11)
